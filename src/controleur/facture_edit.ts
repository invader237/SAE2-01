...
vueFactureEdit.init({
                    ...
                    ,btnValiderContenue		:document.querySelector('[id=btn_contenue_valider]')
                    ...
                    ,edtQte         :document.querySelector('[id=edt_contenue_qte]')
                    ,edtContenueQte :document.querySelector('[id=contenue_qte]')
                    ,btnValiderEquipt:document.querySelector('[id=btn_contenue_valider]')
                    ,btnAnnulerEquipt:document.querySelector('[id=btn_contenue_annuler]')
